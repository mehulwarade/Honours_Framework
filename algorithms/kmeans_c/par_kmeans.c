...
#define num_point 288000;
#define num_cluster 48;
...
int main(int argc, char **argv)
{
	...
	// printf("\nI am process %d and my size is = %d\n", rank, p_data.secondary_dim);
	...
	if (rank == 0)
	{
		...
		printf("Iterations: %d Time: %d.%06d", (int)iter,(int)lapsed.tv_sec, (int)lapsed.tv_usec); 
